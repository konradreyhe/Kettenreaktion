...
**Permanent Docs:**
- `CLAUDE.md` - AI-facing quick reference (code style, design system, rules)
- `PRINCIPLES.md` - This file (engineering principles)
- `docs/HANDOVER.md` - Full project handover (architecture, APIs, status)
- `docs/API.md` - API reference and route contracts
- `docs/ARCHITECTURE.md` - System architecture and module boundaries
- `docs/COMPONENTS.md` - UI and composition component patterns
- `docs/guides/SECURITY.md` - Security architecture and operational guidance
- `docs/guides/GAMEPLAY.md` - Game mechanics and physics deep-dive
- `docs/plans/DEPLOYMENT.md` - Deployment plan and environment setup notes
